...
import 'package:jss_flutter/screens/otherThanSkill.dart';



class ProjectTaken extends StatefulWidget {
  ProjectTaken(this.darpanId,this.compStatusList,this.heading,{Key? key}) : super(key: key);
  String darpanId;
  List<CompStatusList>? compStatusList;
  String heading;
  @override
  State<ProjectTaken> createState() => _ProjectTakenState();
}

class _ProjectTakenState extends State<ProjectTaken>  {
                            ...
                            return   GestureDetector(
                              onTap: (){
                                Navigator.of(context).push(PageRouteBuilder(
                                  pageBuilder: (context, animation, secondaryAnimation) =>  OtherThanSkill(widget.darpanId, widget.compStatusList![index]!.component,widget.heading,gettitle(widget.compStatusList![index].component.toString()),),
